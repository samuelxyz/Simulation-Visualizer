...
#include <pathlib/MCP_Interface.h>
#include <pathlib/Path.h>
#include <pathlib/PathOptions.h>
#include <pathlib/Macros.h>
#include <pathlib/Output.h>
#include <pathlib/Output_Interface.h>
#include <pathlib/Options.h>
